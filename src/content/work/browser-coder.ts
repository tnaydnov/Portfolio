...
export const browserCoder: Project = {
  ...
  role: "Collaborating engineer · integration, debugging & architecture",
  team: "Contributor to Nina Sokolov's Browser Coder project",
  started: "2026-04",
  status: "live",
  ...
  sections: [
    {
      ...
      body: [
        "Browser Coder is an existing teaching IDE that I joined as a collaborator. A learner can work in its full browser interface, or encounter a smaller coding activity embedded in a learning platform such as Arc.",
