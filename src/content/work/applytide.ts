...
export const applytide: Project = {
  ...
  snapshot: {
    ...
    proof: "Archived public source and recorded local workflows: installed extension capture, a selected-role resume review, persisted stage changes, notes, documents and reminders.",
  },
  tier: "flagship",
  ...
  evidenceNote: "Built independently from August 2025 to April 2026. September 2026 captures run the archived product with a fresh database and fictional account. The installed extension and selected-role document review were exercised against the real backend. Review uses a local heuristic fallback; paid AI and external delivery remain unexercised.",
  metrics: [
    ...
    { label: "AI controls", value: "Usage accounting", note: "Per-user controls and a daily budget check; not a hard spending guarantee" },
  ],
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "The provider layer records usage and account attribution alongside configurable budget checks and request limits. The source also implements cookie-based sessions and session revocation. Some security and settings paths are incomplete; the case distinguishes those from demonstrated account workflows.",
      ],
    },
    {
      stage: "build",
      ...
      body: [
        "The React interface talks to a layered FastAPI backend backed by PostgreSQL and Redis. A separate Node service renders email. Scheduler and reminder-worker code exists, with incomplete delivery paths documented in the source review.",
